...
export default function RFQBookingHandoff({
  ...
  if (bookingHandoffData === null) {
    return (
      <div className="bg-white border border-slate-200 rounded-xl p-12 text-center shadow-xs" data-testid="rfq-booking-loading">
        ...
        <h3 className="text-sm font-bold text-slate-900 mb-1">Loading Carrier Booking Handoff...</h3>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm">
        <div className="flex items-center justify-between gap-2 mb-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] px-2 py-0.5 rounded-full font-bold bg-indigo-50 text-indigo-700 border border-indigo-200/60">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-5 gap-2 pt-1 border-t border-slate-100">
          {/* Stage 1: Lead */}
          <div
            onClick={() => rfq?.lead_id && navigate(`/dashboard/leads/${rfq.lead_id}`)}
            className="flex items-center justify-between p-2 rounded-lg bg-slate-50 border border-slate-200/70 cursor-pointer hover:bg-slate-100 transition-colors"
          >
          ...
          >
            <div className="min-w-0">
              <span className="text-[10px] font-extrabold text-indigo-600 uppercase block">4. Carrier Booking</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-7 bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
            ...
            <div className="space-y-2.5">
              ...
              <div className="flex items-center justify-between p-3 rounded-lg border bg-slate-50/60 border-slate-200/80 text-xs">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <strong className="text-slate-800 block">Commercial Quote Approval</strong>
                ...
                <span className={`px-2 py-0.5 rounded font-bold text-[10px] ${isQuoteApproved ? 'bg-emerald-100 text-emerald-800' : 'bg-rose-100 text-rose-800'}`}>
              ...
              <div className="flex items-center justify-between p-3 rounded-lg border bg-slate-50/60 border-slate-200/80 text-xs">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <strong className="text-slate-800 block">Carrier Allocation</strong>
                    <span className="text-slate-500 text-[11px]">
                ...
                <span className={`px-2 py-0.5 rounded font-bold text-[10px] ${isCarrierSelected ? 'bg-emerald-100 text-emerald-800' : 'bg-rose-100 text-rose-800'}`}>
              ...
              <div className="flex items-center justify-between p-3 rounded-lg border bg-slate-50/60 border-slate-200/80 text-xs">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <strong className="text-slate-800 block">Trade & Cargo Parameters</strong>
                    <span className="text-slate-500 text-[11px]">
                ...
                <span className={`px-2 py-0.5 rounded font-bold text-[10px] ${isTradeReqsComplete ? 'bg-emerald-100 text-emerald-800' : 'bg-amber-100 text-amber-800'}`}>
              ...
              <div className="flex items-center justify-between p-3 rounded-lg border bg-slate-50/60 border-slate-200/80 text-xs">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <strong className="text-slate-800 block">Mandatory Documentation</strong>
                    <span className="text-slate-500 text-[11px]">
                ...
                <span className={`px-2 py-0.5 rounded font-bold text-[10px] ${isDocsComplete ? 'bg-emerald-100 text-emerald-800' : 'bg-amber-100 text-amber-800'}`}>
          ...
          <div className="lg:col-span-5 bg-gradient-to-br from-amber-50/90 to-orange-50/60 border border-amber-200 rounded-xl p-5 shadow-sm flex flex-col justify-between">
            <div>
            ...
            <div className="space-y-2 pt-3 border-t border-amber-200/60">
              ...
              {!isDocsComplete && (
                <button
                  ...
                  className="w-full py-2.5 px-3.5 rounded-lg bg-white text-slate-800 border border-slate-300 text-xs font-bold hover:bg-slate-50 transition-colors flex items-center justify-center gap-2"
                >
      ...
      {isEligible && bookings.length === 0 && (
        <div className="bg-white rounded-xl border border-emerald-200 overflow-hidden shadow-sm">
          {/* Header Banner */}
          <div className="p-5 bg-gradient-to-r from-emerald-50 via-teal-50 to-emerald-50 border-b border-emerald-200/80 flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/70">
                ...
                <span className="text-xs text-slate-500 block mt-1">
                  Quote Ref: <strong className="font-mono text-slate-700">{approvedQuote?.quote_reference || `#${eligibility.approved_quote_id || 'N/A'}`}</strong>
                </span>
              </div>
              ...
              <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/70">
                ...
                <p className="text-xs font-medium text-slate-800 truncate" title={rfq?.items?.[0]?.description}>
            ...
            <div className="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-sm">
              ...
              <div className="p-5 border-b border-slate-100 bg-slate-50/70 flex flex-wrap items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 flex items-center gap-2 mt-0.5">
                      <span>Carrier: <strong className="text-slate-700">{activeBooking.carrier_name}</strong></span>
                      {activeBooking.carrier_scac && (
                        <span className="font-mono px-1.5 py-0.2 rounded bg-slate-200 text-[10px] text-slate-700 font-bold">
                          {activeBooking.carrier_scac}
                        </span>
                      )}
                      {activeBooking.quote_id && (
                        <span>• Linked Quote: <strong className="font-mono text-slate-700">#{activeBooking.quote_id}</strong></span>
                      )}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-3.5 py-2 rounded-lg bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 text-xs font-semibold transition-colors inline-flex items-center gap-1.5 shadow-sm"
                  >
                  ...
                  <button
                    onClick={handleOpenCreateModal}
                    className="px-3 py-2 rounded-lg bg-indigo-50 hover:bg-indigo-100 text-indigo-700 text-xs font-bold transition-colors inline-flex items-center gap-1 border border-indigo-200/60"
                  ...
                  {[
                    ...
                    return (
                      <div key={step.id} className="flex flex-col items-center text-center relative z-10">
                        ...
                        <span className={`text-xs font-bold ${state === 'active' ? 'text-indigo-600' : state === 'completed' ? 'text-emerald-700' : 'text-slate-500'}`}>
                          {step.label}
                        </span>
                ...
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/70">
                  ...
                  <div className="space-y-2">
                    <div>
                      ...
                      <p className="text-sm font-bold text-slate-800">{activeBooking.origin_port}</p>
                    </div>
                    <div className="border-t border-slate-200 pt-2">
                      <span className="text-[10px] font-semibold text-slate-400 uppercase">Destination Port</span>
                      <p className="text-sm font-bold text-slate-800">{activeBooking.destination_port}</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="p-4 bg-slate-50/80 border-t border-slate-100 flex flex-wrap items-center justify-between gap-3">
                <div className="flex items-center gap-2 text-xs text-slate-500">
                  <span>Created by: <strong className="text-slate-700">{activeBooking.created_by || 'Operations Team'}</strong></span>
                  <span>•</span>
                ...
                {bookings.map(b => (
                  <div key={b.id} className="p-3.5 flex flex-wrap items-center justify-between gap-3 text-xs">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-slate-600 font-medium">{b.carrier_name}</span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-xs rounded-lg border border-slate-200 bg-slate-50 font-mono focus:ring-2 focus:ring-indigo-500 outline-none"
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-xs rounded-lg border border-slate-200 bg-slate-50 font-medium focus:ring-2 focus:ring-indigo-500 outline-none"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-xs rounded-lg border border-slate-200 bg-slate-50 focus:ring-2 focus:ring-indigo-500 outline-none"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-xs rounded-lg border border-slate-200 bg-white focus:ring-2 focus:ring-indigo-500 outline-none"
