...
with open('/Users/varun.kanade/.gemini/antigravity-ide/brain/0438df59-754c-494a-bf4e-8bd5ba8af0e1/scratch/cc_jsx.js', 'r') as f:
    jsx = f.read()

# Insert before 'export default function ImportExportBasicsPage'
